...
const entries: TimelineItemStruct[] = projects
    .filter((proj) => proj.type === "software")
    .reverse();
const TimelineWrapper = () => {
    return (
        <Box sx={{ textAlign: "center", mb:4 }}>
            <Typography variant="projectContentHeader">Projects</Typography>
            <Divider
                sx={{
                    my: 2,
                    mx: "auto",
            ...
            />
            <TimelineComponent entries={entries} />
        </Box>
    );
};
